<%-- 
    Document   : modifier film
    Created on : 18 déc. 2023, 14:55:29
    Author     : MSI
--%>
...
<section style="width: 100%;">
    <div class="grid-containerS container p-2">
        <div class="button-container">
            <h4> Film Modifié avec Sucées </h4>
            <form action="modifier film.jsp" method="post">
    ...
    String requette="update film  SET titre='"+titre+"' , realisateur='"+realisateur+"'"+" where idfilm="+idfilm;
    try {
