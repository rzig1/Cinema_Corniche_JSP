<%-- 
    Document   : modifier client
    Created on : 15 déc. 2023, 15:10:09
    Author     : MSI
--%>
...
<section style="width: 100%;">
    <div class="grid-containerS container p-2">
        <div class="button-container">
            <h4> Client Modifié avec Succées</h4>
            <form action="modifier client.jsp" method="post">
                ...
                <input type="text" id="Prenomp" name="Prenomp" required>
            
                <label for="Datec">Date de naissance :</label>
                <input type="date" id="Datec" name="Datec" required>
            
                <label for="Cin">CIN :</label>
                <input type="text" id="Cin" name="Cin" required>
            
                <label for="Ademailc">Adresse email :</label>
                <input type="email" id="Ademailc" name="Ademailc" required>
    ...
    String requette="update client  SET NomP='"+NomP+"' , Prenomp='"+Prenomp+"' , Datec='"+Datec+"' , Cin='"+Cin+"' , ADemailc='"+Ademailc+"' where idClient="+idClient;
    try {
