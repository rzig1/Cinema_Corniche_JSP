<%-- 
    Document   : afficher client.jsp
    Created on : 15 déc. 2023, 14:41:14
    Author     : MSI
--%>
    ...
    <div class="grid-containerS container p-2">
        <%
            ...
            try {
                ...
                out.print("<table>");
                out.print("<tr><th>ID</th><th>Nom</th><th>Prénom</th><th>Date de Naissance</th><th>CIN</th><th>Email</th></tr>");
                while(rs.next()){
