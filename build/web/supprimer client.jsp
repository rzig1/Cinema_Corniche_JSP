<%-- 
    Document   : supprimer client
    Created on : 15 déc. 2023, 15:41:59
    Author     : MSI
--%>
...
<section style="width: 100%;">
    <div class="grid-containerS container p-2">
        <div class="button-container">
            <h4> Client Supprimé avec Succées </h4>
            <form action="supprimer client.jsp" method="post">
...
<%
    ...
    String requette="delete from ticket where idClient="+idClient;
    try {
    ...
    String requette1="delete from client where idClient="+idClient;
    try {
        Class.forName("com.mysql.jdbc.Driver");
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/gestion?useSSL=false", "root", "admin");
        Statement St = connection.createStatement();
