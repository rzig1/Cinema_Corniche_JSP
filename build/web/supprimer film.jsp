<%-- 
    Document   : supprimer film
    Created on : 18 déc. 2023, 14:43:29
    Author     : MSI
--%>
...
<section style="width: 100%;">
    <div class="grid-containerS container p-2">
        <div class="button-container">
            <form action="supprimer film.jsp" method="post">
                <h4> Film supprimé avec Succées </h4>
                    
                <label for="idfilm">ID Film:</label>
                <input type="text" id="idfilm" name="idfilm" required>
            
                <button type="submit">Supprimer Film</button>
              </form>
        </div>
      </div>
</section>
    ...
    String requette="delete from ticket where idfilm="+idfilm;
    try {
    ...
    String requette1="delete from film where idfilm="+idfilm;
    try {
        Class.forName("com.mysql.jdbc.Driver");
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/gestion?useSSL=false", "root", "admin");
        Statement St = connection.createStatement();
