<%-- 
    Document   : ajouter ticket
    Created on : 15 déc. 2023, 15:59:08
    Author     : MSI
--%>
...
<section style="width: 100%;">
    <div class="grid-containerS container p-2">
        <div class="button-container">
            <h4>Ticket Ajouté avec succées </h4>
            <form action="ajouter ticket.jsp" method="post">
                ...
                <button type="submit">Insérer Ticket</button>
              </form>
        </div>
      </div>
</section>
    ...
    String requette = "insert into ticket values (null,'" + idClient + "','" + idfilm +"','" + salle +"')";
    try {
